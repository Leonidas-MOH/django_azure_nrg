...
#######################
from .models import FundamentalsMFv
ModelClassName = FundamentalsMFv

ModelStr = 'fundamentalsMFv'
AppStr   = 'datapool'

PathStart = AppStr+':'+ModelStr 

PageTitle = 'Meteologica Forecast'
FormName  = 'Meteologica Forecast'
...
ModelClassNameStr = 'FundamentalsMFv'
Model_Fields = ['datetimeval','country','consumption','wind','pv']
