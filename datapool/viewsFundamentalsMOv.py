...
#######################
from .models import FundamentalsMOv
ModelClassName = FundamentalsMOv

ModelStr = 'fundamentalsMOv'
AppStr   = 'datapool'
PathStart = AppStr+':'+ModelStr 

PageTitle = 'Meteologica Observed'
FormName  = 'Meteologica Observed'
...
ModelClassNameStr = 'FundamentalsMOv'
