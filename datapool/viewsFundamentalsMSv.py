...
#######################
from .models import FundamentalsMSv
ModelClassName = FundamentalsMSv

ModelStr = 'fundamentalsMSv'
AppStr   = 'datapool'

PathStart = AppStr+':'+ModelStr 

PageTitle = 'Meteologica Seasonal'
FormName  = 'Meteologica Seasonal'
...
ModelClassNameStr = 'FundamentalsMSv'
