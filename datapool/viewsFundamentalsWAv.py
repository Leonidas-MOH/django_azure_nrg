...
#######################
from .models import FundamentalsWAv
ModelClassName = FundamentalsWAv

ModelStr = 'fundamentalsWAv'
AppStr   = 'datapool'

PathStart = AppStr+':'+ModelStr 

PageTitle = 'Wattsight Actuals'
FormName  = 'Wattsight Actuals'
...
ModelClassNameStr = 'FundamentalsWAv'
Model_Fields = ['datetimeval','country','consumption','wind','pv','nuclear',
                  'coal','lignite','ccgt','hydro','commercial_flow','ntc']
