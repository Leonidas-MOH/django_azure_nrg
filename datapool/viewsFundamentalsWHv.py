...
#######################
from .models import FundamentalsWHv
ModelClassName = FundamentalsWHv

ModelStr = 'fundamentalsWHv'
AppStr   = 'datapool'

PathStart = AppStr+':'+ModelStr 

PageTitle = 'Wattsight Historical'
FormName  = 'Wattsight Historical'
...
ModelClassNameStr = 'FundamentalsWHv'
Model_Fields = ['datetimeval','country','consumption','wind','pv','hydro']
