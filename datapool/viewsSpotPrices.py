...
#######################
from .models import SpotPrices
ModelClassName = SpotPrices
...
PageTitle = 'Spot Prices'
FormName  = 'Spot Prices'
...
ModelClassNameStr = 'SpotPrices'
Model_Fields = ['datetimeval','country','price_forecast','price_actual']
