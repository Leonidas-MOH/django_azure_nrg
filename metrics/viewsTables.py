...
#######################
from .models import TableParam

ModelClassName = TableParam
ModelStr = 'tables'
AppStr   = 'metric'
...
ModelClassNameStr = 'Tables'
Model_Fields = ['table_name','description']
Table_Sequence = ['table_name','detail','detailed','description','...']
Table_Exclude = ['id']
Rows_Per_Page = 25
