...
PageTitle = 'Task Param'
FormName  = 'Task Parameters'
...
ModelClassNameStr = 'taskparam'
Model_Fields = ['task','param_name','param_value']
Table_Sequence = ['task','detail','detailed','param_name','param_value','...']
Table_Exclude = ['id']
Rows_Per_Page = 25
